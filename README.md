...
GitHub Actions가 매일 한국 시간 오전 9시 15분과 오후 6시 15분에 KBO 공식 일정 페이지의 데이터를 확인합니다. 새 경기나 결과 변경이 있을 때만 JSON을 커밋하며, 스키마·팀·경기장·중복·체크섬 검증에 실패하면 기존 정상 파일과 Pages 배포본을 유지합니다.
